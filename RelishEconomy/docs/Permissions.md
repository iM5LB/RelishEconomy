...
| `relish.economy.eco.clear` | Zero out player balances (offline-safe) | op |
| `relish.economy.eco.info` | View player balances (offline-safe) | op |
| `relish.economy.vault.use` | Open the personal vault block | true |
